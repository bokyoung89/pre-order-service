...
public class FollowController {
    ...
    public Response<Void> addFollow(@PathVariable(name="followeeId") Long followeeId,
    ...
    public Response<Void> cancelFollow(@PathVariable(name="followeeId") Long followeeId,
                                       @RequestHeader(name="principalId") Long principalId) {
