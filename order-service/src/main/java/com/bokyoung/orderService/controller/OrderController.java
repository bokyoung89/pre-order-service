...
import com.bokyoung.orderService.dto.request.OrderCreateRequest;
import com.bokyoung.orderService.dto.response.OrderResponse;
import com.bokyoung.orderService.dto.response.Response;
import com.bokyoung.orderService.model.Order;
import com.bokyoung.orderService.service.OrderService;
...
public class OrderController {
     ...
     */
    @PostMapping
    public Response<Void> createOrder(@RequestBody OrderCreateRequest request,
                                 @RequestHeader(name = "principalId") Long principalId) {
        orderService.createOrder(request.getProductId(), request.getQuantity(), request.getAddress(), principalId);
